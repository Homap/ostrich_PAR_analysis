...
kosambi_female <- rate_function(genetic_map = sex_averaged_map, len_markers = 193, column = 5, span = 0.3)
kosambi_male <- rate_function(genetic_map = sex_averaged_map, len_markers = 193, column = 6, span = 0.3)
kosambi_sex_averaged <- rate_function(genetic_map = sex_averaged_map, len_markers = 193, column = 7, span = 0.3)
