...
def main():
	...
	if chr_seg == "Z":
		...
		# ******************************************************************************			
				...
				for l in vcf_dict[scaffold]:
					if int(l[0]) <= Z_scaffold_length[scaffold]:
						...
						l[0] = str(Z_scaffold_length["superscaffold26"] + (Z_scaffold_length[scaffold] - int(l[0])))
						l[1] = str(Z_scaffold_length["superscaffold26"] + (Z_scaffold_length[scaffold] - int(l[1])))
						new_list.append(l)
				for i in new_list:
					ind = new_list.index(i)
					print ("ChrZ" + "\t" + str(i[1]) + "\t" + str(int(i[0])) + "\t" + scaffold + "\t" + ["\t".join(map(str,x)) for x in scaf_list][ind])
		# ******************************************************************************			
		...
		# ******************************************************************************			
				...
				for l in vcf_dict[scaffold]:
					scaf_list.append(l[0:])
					l[0] = str(Z_scaffold_length["superscaffold26"] + Z_scaffold_length["superscaffold54"] + Z_scaffold_length["superscaffold35"] + (Z_scaffold_length[scaffold] - int(l[0])))
					l[1] = str(Z_scaffold_length["superscaffold26"] + Z_scaffold_length["superscaffold54"] + Z_scaffold_length["superscaffold35"] + (Z_scaffold_length[scaffold] - int(l[1])))
					new_list.append(l)
				for i in new_list:
					ind = new_list.index(i)
					print ("ChrZ" + "\t" + str(i[1]) + "\t" + str(int(i[0])) + "\t" + scaffold + "\t" + ["\t".join(map(str,x)) for x in scaf_list][ind])
		...
		# ******************************************************************************			
				...
				for l in vcf_dict[scaffold]:
					if int(l[0]) <= PAR_scaffold_length[scaffold]: 
						scaf_list.append(l[0:])
						l[0] = str(PAR_scaffold_length["superscaffold26"] + (PAR_scaffold_length[scaffold] - int(l[0])))
						l[1] = str(PAR_scaffold_length["superscaffold26"] + (PAR_scaffold_length[scaffold] - int(l[1])))
						new_list.append(l)
				for i in new_list:
					ind = new_list.index(i)
					print ("ChrZ" + "\t" + str(i[1]) + "\t" + str(int(i[0])) + "\t" + scaffold + "\t" + ["\t".join(map(str,x)) for x in scaf_list][ind])
		...
		# ******************************************************************************			
				...
				for l in vcf_dict[scaffold]:
					if int(l[0]) >= PAR_start[1]:
						scaf_list.append(l[0:])
						l[0] = str(PAR_scaffold_length["superscaffold26"] + PAR_scaffold_length["superscaffold54"] + PAR_scaffold_length["superscaffold35"] + (Z_scaffold_length[scaffold] - int(l[0])))
						l[1] = str(PAR_scaffold_length["superscaffold26"] + PAR_scaffold_length["superscaffold54"] + PAR_scaffold_length["superscaffold35"] + (Z_scaffold_length[scaffold] - int(l[1])))
						new_list.append(l)
				for i in new_list:
					ind = new_list.index(i)
					print ("ChrZ" + "\t" + str(i[1]) + "\t" + str(int(i[0])) + "\t" + scaffold + "\t" + ["\t".join(map(str,x)) for x in scaf_list][ind])		
