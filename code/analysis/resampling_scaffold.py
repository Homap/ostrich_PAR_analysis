...
"""
python resampling_scaffold.py \
../data/female_data/${subspecies}.${window}.FEMALE.repeatCDS.overlap.density.sorted.pi.INTERGENIC.txt  \
> ../data/female_data/${subspecies}.${window}.female.INTERGENIC.mean.CI.txt

python resampling_scaffold.py ../data/female_data/black.500Kb.FEMALE.repeatCDS.overlap.density.sorted.pi.INTERGENIC.txt 
"""
...
#*****************************************************************************
# f1_dict = {superscaffold_winStart_winEnd:[line]}
#*****************************************************************************
# Create a dictionary with key being 
# superscaffold_winStart_winEnd and value being
# the whole line
f1_dict = {}
f1_list = []
for line in f1:
...
print(f1_list)
#print(float(f1_dict['superscaffold36_2500000_3000000'][0][6]))
#*****************************************************************************
# Create a resampling dictionary
#*****************************************************************************
# f1_dict = {superscaffold_winStart_winEnd:[line]}
# f1_list = ['superscaffold26_0_500000', 'superscaffold35_0_500000'...]
# resample_dict = {'superscaffold26_0_500000': [[250.85449999999952, 260917]], ...}
#*****************************************************************************
resample_dict = {}
for key in f1_list:
	pi_count = []
...
#print(update_dict['superscaffold36_2500000_3000000'])
#print(float(update_dict['superscaffold36_2500000_3000000'][0][6]))
