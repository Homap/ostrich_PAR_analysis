...
module load bioinfo-tools samtools bcftools psmc seqtk
...
fourline_fastq=$5
repeat_bed=$6
fourline_fastq_repeat_masked=$7
cds_bed=$8
fourline_fastq_repeat_cds_masked=$9
psmcfa=$10
zscaffold=$11
autosome_psmcfa=$12
autosome_psmcfa_out=$13
psmc_image=$14
split_autosome_psmcfa_out=$15
...
samtools mpileup -Q20 -q20 -C50 -uf $ref $bamfile | bcftools call --threads $threads -c - | \
vcfutils.pl vcf2fq -Q 25 -d 13.66457 -D 81.9874 | gzip > $fastq
