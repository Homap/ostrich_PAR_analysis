...
echo "Run PSMC"
psmc -N25 -t15 -r5 -p "4+25*2+4+6" -o ../data/psmc/P1878_121.autosome.psmc.out ../data/psmc/P1878_121.autosome.psmcfa

echo "Create the PSMC plot"
psmc_plot.pl -g 4 -u 4.63e-09 ../data/psmc/P1878_121.autosome.psmc.image ../data/psmc/P1878_121.autosome.psmc.out

echo "Split fasta for resampling"
splitfa ../data/psmc/P1878_121.autosome.psmcfa > ../data/psmc/P1878_121.autosome.split.psmcfa
