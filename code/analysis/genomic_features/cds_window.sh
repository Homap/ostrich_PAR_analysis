...
bedtools intersect -a ../../../data/sliding_window/z_scaf_${w_size}_${w_size}.bed -b - -wao > ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.txt
python get_sum_overlapping.py ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.txt > ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.sum.txt

python get_density_feature.py ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.sum.txt ${fasta} ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.density.txt
sort -k1,1 -k2n,2 ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.density.txt > ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.density.sorted.txt

rm -f ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.density.txt ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.sum.txt ../../../data/genomic_features/z_scaf.${w_size}.CDS.overlap.txt
done

python ../../processing/scaffold_to_chr.py \
../../../data/genomic_features/z_scaf.200000.CDS.overlap.density.sorted.txt Z > ../../../data/genomic_features/z_scaf.200000.CDS.overlap.density.sorted.coord.txt
...
bedtools intersect -a ../../../data/sliding_window/chr4_${w_size}_${w_size}.bed -b - -wao > ../../../data/genomic_features/chr4.scaf.${w_size}.CDS.overlap.txt
...
bedtools intersect -a ../../../data/sliding_window/chr5_${w_size}_${w_size}.bed -b - -wao > ../../../data/genomic_features/chr5.scaf.${w_size}.CDS.overlap.txt
