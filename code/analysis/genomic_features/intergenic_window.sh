...
bedtools intersect -a ../../../data/sliding_window/${seg}.scaf.${w_size}.bed -b - -wao > ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.txt
python get_sum_overlapping.py ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.txt > ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.sum.txt

python get_density_feature.py ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.sum.txt ${fasta} ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.density.txt
sort -k1,1 -k2n,2 ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.density.txt > ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.density.sorted.txt

rm -f ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.density.txt ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.sum.txt ../../../data/genomic_features/${seg}.scaf.${w_size}.intergene.overlap.txt
done
done
...
bedtools intersect -a ../../../data/sliding_window/chr4.${w_size}.bed -b - -wao > ../../../data/genomic_features/chr4.scaf.${w_size}.intergene.overlap.txt
...
bedtools intersect -a ../../../data/sliding_window/chr5.${w_size}.bed -b - -wao > ../../../data/genomic_features/chr5.scaf.${w_size}.intergene.overlap.txt
