...
../../../data/bed/z_scaf.bed 200000 150000
done

echo "Concatenate all scaffolds"
awk 'NR==1' ${ld_window_z}/superscaffold26.pairwise.LD.05-500.200kbBin.150.kbStep.out > ${ld_window_z}/header
cat ${ld_window_z}/*.pairwise.LD.05-500.200kbBin.150.kbStep.out | grep -v "Dprime" | cat ${ld_window_z}/header - >> ${ld_window_z}/Z.scaffolds.LD.05-500.200kbBin.150.kbStep.out

echo "converting scaffold coordinates into chromosome coordinates"
python ../../processing/scaffold_to_chr.py ${ld_window_z}/Z.scaffolds.LD.05-500.200kbBin.150.kbStep.out Z > ${ld_window_z}/Z.LD.05-500.200kbBin.150.tab
...
../../../data/lastz/gg_chr4_ostrich.bed 200000 150000
done
...
../../../data/lastz/gg_chr5_ostrich.bed 200000 150000
done

echo "concatenating pairwise LD for chromosome 4 and 5"
awk 'NR==1' ${ld_window_autosome}/chr4/scaffold1404.pairwise.LD.05-500.200kbBin.150.kbStep.out > ${ld_window_autosome}/header

cat ${ld_window_autosome}/chr4/*.pairwise.LD.05-500.200kbBin.150.kbStep.out >> ${ld_window_autosome}/chr4/chr4.pairwise.LD.05-500.200kbBin.150.kbStep.out
cat ${ld_window_autosome}/chr5/*.pairwise.LD.05-500.200kbBin.150.kbStep.out >> ${ld_window_autosome}/chr5/chr5.pairwise.LD.05-500.200kbBin.150.kbStep.out

cat ${ld_window_autosome}/chr4/chr4.pairwise.LD.05-500.200kbBin.150.kbStep.out ${ld_window_autosome}/chr5/chr5.pairwise.LD.05-500.200kbBin.150.kbStep.out >> ${ld_window_autosome}/chr4_5_pairwise_LD.tab
