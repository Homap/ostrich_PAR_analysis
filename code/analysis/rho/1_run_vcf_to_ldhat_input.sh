...
python vcf_to_ldhat_out.py ${chr4_dir}/superscaffold11.chr4.vcf.gz ../../../data/lastz/gg_chr4_ostrich.bed 2000 200 superscaffold11 10000 ../../../data/rho/ldhat_input/chr4

echo "----------------------chr5----------------------"
export chr5_dir=../../../data/vcf/ld_vcf/a_vcf/chr5
python vcf_to_ldhat_out.py ${chr5_dir}/superscaffold8.chr5.vcf.gz ../../../data/lastz/gg_chr5_ostrich.bed 2000 200 superscaffold8 10000 ../../../data/rho/ldhat_input/chr5
...
do
    echo $scaffold
    python vcf_to_ldhat_out.py ${z_dir}/z_vcf.gz ../../../data/bed/par_scaf.bed 2000 200 $scaffold 10000 ../../../data/rho/ldhat_input/z/par
done
echo "----------------------chrZ--nonPAR--------------"
...
do
    echo $scaffold
    python vcf_to_ldhat_out.py ${male_nonPAR} ../../../data/bed/nonpar_scaf.bed 2000 200 $scaffold 10000 ../../../data/rho/ldhat_input/z/nonpar
done
