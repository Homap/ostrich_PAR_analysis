...
for line in snp_list:
	if not line.startswith("CHROM"):
		...
		if not '0' in [allele1, allele2]:
			snp_dict[scaf_pos] = [allele1, allele2]
#print(snp_dict)
...
fourfold_counts.write("CHROM"+"\t"+"POS"+"\t"+"N_ALLELES"+"\t"+"N_CHR"+"\t"+"{ALLELE:COUNT}"+"\n")
zerofold_counts.write("CHROM"+"\t"+"POS"+"\t"+"N_ALLELES"+"\t"+"N_CHR"+"\t"+"{ALLELE:COUNT}"+"\n")
...
for line in annt_list:
	...
	if not line[1] == "mRNA_id":
		...
		if scaf_pos in snp_dict.keys():
			if syn == "1.0":
				fourfold_counts.write(scaf_pos.split("_")[0]+"\t"+scaf_pos.split("_")[1]+"\t"+"2"+"\t"+"20"+"\t"+snp_dict[scaf_pos][0]+"\t"+snp_dict[scaf_pos][1]+"\n")
			elif miss == "1.0":
				zerofold_counts.write(scaf_pos.split("_")[0]+"\t"+scaf_pos.split("_")[1]+"\t"+"2"+"\t"+"20"+"\t"+snp_dict[scaf_pos][0]+"\t"+snp_dict[scaf_pos][1]+"\n")
